  ...
  return (
    <div>
      ...
      <div className='absolute w-full h-full flex items-center justify-center'>
        <form
          className='p-10 bg-black w-full md:w-3/12 text-white rounded-lg bg-opacity-80'
        ...
        >
          ...
          {!signInForm && (
            <>
              ...
              <small
                ...
                aria-label='Your username must contain only letters and numbers'
              >
          ...
          {!signInForm && (
            <small
              className='text-gray-500'
              aria-label='Example - user@example.com'
            >
          ...
          {!signInForm && (
            ...
            >
              ...
              lowercase letter, and one number. Ex: Password1, StrongPass123
            </small>
          )}
